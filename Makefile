...
# quay.io/packet-capture-operator-bundle:$VERSION and quay.io/packet-capture-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/rimitche/packet-capture-operator
